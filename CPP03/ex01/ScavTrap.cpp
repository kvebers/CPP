...
/*   Updated: 2023/06/11 07:46:02 by kvebers          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ScavTrap::ScavTrap() : ClapTrap("SCAVTRAP") {
	std::cout << "The ScavTrap: " << this->_name << " has been created, long live the ScavTrap"
			  << std::endl;
	this->_name = "Default";
	this->_hitPoints = 100;
...
ScavTrap::ScavTrap(const std::string &name) : ClapTrap(name) {
	std::cout << "ScavTrap: " << this->_name << " Parameterized Constructor has been called"
			  << std::endl;
	this->_hitPoints = 100;
	this->_energyPoints = 50;
	this->_attackDamage = 20;
...
ScavTrap &ScavTrap::operator=(ScavTrap &trap) {
	std::cout << "ScavTrap:  " << this->_name << " COpy assigment opperator has been called"
			  << std::endl;
