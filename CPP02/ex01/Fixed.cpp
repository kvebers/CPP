...
/*   Updated: 2023/06/14 08:48:14 by kvebers          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
So what I understood from the subject about the overloads, we do so, to to simplfy the output and
make it more intuitive, exaple: Fixed f(3.14); Without overload std::cout << f; Displays
adress:0x7ffd8e3f4abc so to actually use it you would need to std::cout << f.toFloat; with overload
